...
<div class="col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
        ...
        <div class="panel-heading" style="color:#191970;"><b>Test Method For Customer</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
        ...
        <form class="form-horizontal" action="" style="margin-top:10px;" name="test_method_for_customer_form" id="test_method_for_customer_form">
          ...
          <div class="form-group form-group-sm" id="form-group_for_customer_name">
            <label class="control-label col-sm-3" for="customer_name" style="margin-right:0px; color:#00008B;">Customer Name:</label>
              <div class="col-sm-4">
