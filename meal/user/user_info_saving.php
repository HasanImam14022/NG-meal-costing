...
else if( mysqli_num_rows($result) < 1)
{
	...
	$insert_sql_statement="insert into `user_info` ( `user_name`,`employee_name`,`user_id`,`password`,`confirm_password`,`user_type`,`religion`,`status`,`email`,`contact_no`,`department`,`designation`,`profile_picture`,`recording_person_id`,`recording_person_name`,`recording_time` ) values ('$user_name','$employee_name','$user_id','$password','$confirm_password','$user_type','$religion','$status','$email','$contact_no','$department','$designation','$profile_picture_name','$session_user_id','$session_user_name',NOW())";

	mysqli_query($con,$insert_sql_statement) or die(mysqli_error($con));

	$insert_sql_statement_for_login="insert into `user_login` ( `user_name`,`user_id`,`password`,`user_type`,`employee_name`,`status`,`email`,`contact_no`,`department`,`designation`,`profile_picture`,`recording_person_id`,`recording_person_name`,`recording_time` ) values ('$user_name','$user_id','$password','$user_type','$employee_name','$status','$email','$contact_no','$department','$designation','$profile_picture_name','$session_user_id','$session_user_name',NOW())";
