		...
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<form class="form-horizontal" action="" style="margin-top:10px;" name="user_info_form" id="user_info_form" enctype="multipart/form-data" data-parsley-validate>
					  ...
					  <div class="form-group form-group-sm" id="form-group_for_employee_name">
						...
						</div> End of <div class="form-group form-group-sm" id="form-group_for_religion"> -->

						<input type="hidden" class="form-control" id="user_type" name="user_type" value="User" placeholder="<?php echo "User"?>" readonly>

						<!-- <div class="form-group form-group-sm" id="form-group_for_user_type">
								<label class="control-label col-sm-3" for="user_type" style="color:#00008B;">User Type:</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="user_type" name="user_type" value="User" placeholder="<?php echo "User"?>" readonly>
								</div>
								<!-- <i class="glyphicon glyphicon-remove" onclick="Remove_Value_Of_This_Element('user_type')"></i> -->
						<!-- </div>  -->

						<div class="form-group form-group-sm" id="form-group_for_religion">
						<label class="control-label col-sm-3" for="religion" style="margin-right:0px; color:#00008B;">Religion:</label>
							<div class="col-sm-5">
								<select  class="form-control for_auto_complete" id="religion" name="religion">
									<option select="selected" value="select">Select Religion Type</option>
